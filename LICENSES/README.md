...
| libaom | 3.13.1, commit `d772e334cc724105040382a977ebb10dfd393293` | immutable upstream source archive, extracted at build time and statically linked for AV1 IVF/WebM encode/decode and AV1 MP4 decode | BSD-2-Clause with the Alliance for Open Media patent grant | [license](aom.txt), [patent grant](aom-patents.txt) |
