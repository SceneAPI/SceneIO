...
> that exact commit. R4.3 arrays and calibration close at pushed commits
> `f57c677` and `366aac0`. The images-family candidate now uses
> `codecs/images/`; five codec families remain physically flat.
