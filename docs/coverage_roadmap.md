...
> commit. R4.3 arrays through points close at pushed commits through
> `97b24e2`; the reconstruction-family path-only candidate is green locally.
> Sequences and splats remain open.
