...
> commit. R4.3 arrays and calibration close at pushed commits `f57c677` and
> `366aac0`; the images-family path-only candidate is green locally. Five
> physical family moves remain open.
