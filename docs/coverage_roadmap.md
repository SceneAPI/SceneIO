...
> commit. R4.3 arrays through meshes close at pushed commits `f57c677`,
> `366aac0`, `aff2a37`, and `c5de24b`; the points-family path-only candidate is
> green locally. Three physical family moves remain open.
