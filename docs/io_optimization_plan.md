...
cover the live 73-format registry; 37 formats expose 43 bounded selectors. This
...
OpenVDB, USD/USDZ, AVIF, WebM, RTMV, Ogg/Theora, and the NCore V4 catalog unit
bring the current ledger to 172 provisional, two known-gap, and eight
not-applicable operations without changing
that policy.
...
73 formats: 64 single-file containers, five directories, and four multi-file
