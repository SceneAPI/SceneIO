...
- **Status:** Complete and merged as of 2026-08-29. G1 and FC4-FC6 are
  validated. Exact
  implementation candidate `9a20bc61f177c28ba228b89e80cff665e3f1b426`
  passed the complete nonpublishing Release, CI, and sanitizer matrices. PR
  ...
  post-merge CI `33253820086` and Sanitizers `33253820079` passed.
...
- **Authority:** current capabilities remain defined by
  [`format_coverage.md`](../../format_coverage.md). The detailed acceptance
  rules in
  [`remaining_3dcv_profile_checklist.md`](../../remaining_3dcv_profile_checklist.md)
  remain normative. This archived document is the completed ordered execution
  view.
...
| FC7 | Aggregate closure | Exact candidate passes local contracts, the 5,082-test suite, strict benchmark, exact source closure, three installed wheels, hosted oracles, CI, and sanitizers; PR #1 is merged | Exact-head local/package/hosted evidence and reconciled docs | complete |
...
**Program closeout complete:** the reviewable implementation units and hosted
corrections are committed and pushed, and the nonpublishing package/oracle/CI/
sanitizer evidence is recorded above. PR #1 merged the program to `main` as
`b82858d5bc79354107d0d2e3d78260bf62c46ef8`; its post-merge CI and sanitizer
runs passed. Publication remains a separate tag-driven user decision.
