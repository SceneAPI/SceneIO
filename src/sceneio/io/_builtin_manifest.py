...
_NATIVE_SYMBOLS = {
    "pfm": ("read_pfm", "write_pfm", "read_pfm_window"),
    "colmap_sparse": (
        "read_colmap_sparse",
        "write_colmap_sparse",
    ...
    "ksplat": ("read_ksplat", "write_ksplat", "read_ksplat_points"),
    ...
    "stl": ("read_stl", "write_stl", "read_stl_faces"),
    "off": ("read_off", "write_off", "read_off_faces"),
    "gltf": (
    ...
    "transforms_json": ("read_transforms_json", "write_transforms_json"),
    ...
    "opencv_yaml": ("read_opencv_yaml", "write_opencv_yaml"),
    "opencv_xml": ("read_opencv_xml", "write_opencv_xml"),
    "ros_camera_info": ("read_ros_camera_info", "write_ros_camera_info"),
    "kalibr": ("read_kalibr", "write_kalibr"),
    "g2o": ("read_g2o", "write_g2o"),
    "colmap_db": (
        "read_colmap_db",
        "write_colmap_db",
    ...
    "npy": ("read_npy", "read_npy_view", "write_npy"),
    ...
    "xyz": ("read_xyz", "write_xyz", "read_xyz_points"),
    "pts": ("read_pts", "write_pts", "read_pts_points"),
    "las": ("read_las", "write_las", "read_las_points"),
    "laz": ("read_laz", "write_laz", "read_laz_points"),
    "flo": ("read_flo", "read_flo_view", "write_flo"),
    "dmb": ("read_dmb", "write_dmb", "read_dmb_window"),
    "bundler": ("read_bundler", "write_bundler"),
    "bal": ("read_bal", "write_bal"),
    "nvm": ("read_nvm", "write_nvm"),
    "openmvg": ("read_openmvg", "write_openmvg"),
